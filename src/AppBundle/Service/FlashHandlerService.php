...
class FlashHandlerService {
    ...
    {
        $def = array(
            "new-user" => "<h4>Bienvenue sur $value Behive!</h4><p>Amusez vous !</p>",
            ...
            "earn-game" => "<h4>Un nouveau jeu vous attend!</h4><p>Vous avez remporté le jeu " . $value . "</p>",
            ...
            "steam" => "<h4>Synchronisation Steam!</h4><p>$value ont été synchronisé. Félicications!</p>"
        );
